...
from apps.backoffice.views.transport import CreateVehicleAPIView, VehicleListAPIView, UpdateVehicleAPIView, \
    ...
    StudentTransportListAPIView, MyAssignedVehicleAPIView, RouteDetailsAPIView
...
urlpatterns = [
   ...
   path( "rbac/modules/<uuid:module_id>/permissions",ModulePermissionsAPIView.as_view(),name="module-permissions"),
    ...
    path("route/details/<uuid:route_id>",RouteDetailsAPIView.as_view(),),
    ...
    path("my-assigned-vehicle",MyAssignedVehicleAPIView.as_view(),),
    ...
    path("exam/grade/create/<uuid:examination_id>",ExaminationGradeCreateAPIView.as_view(),),
